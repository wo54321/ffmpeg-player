...
#define FFMPEG_CONFIGURATION "--arch=arm --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=h264 --enable-decoder=hevc --disable-hwaccels --disable-muxers --enable-muxer=mpegts --enable-muxer=mp4 --disable-demuxers --enable-demuxer=rtsp --disable-parsers --enable-parser=aac --enable-parser=h264 --enable-parser=hevc --enable-bsfs --disable-bsf=mjpeg2jpeg --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=text2movsub --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --disable-protocol=rtmp --disable-protocol=rtmpt --disable-protocol=sctp --disable-protocol=srtp --disable-devices --enable-filters --disable-iconv --prefix=/Users/mac/Project/android/ijkplayer/android/contrib/build/ffmpeg-armv5/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv5te -mtune=arm9tdmi -msoft-float' --extra-ldflags=' '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/mac/Project/android/ijkplayer/android/contrib/build/ffmpeg-armv5/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/mac/Project/android/ijkplayer/android/contrib/build/ffmpeg-armv5/output/share/ffmpeg"
